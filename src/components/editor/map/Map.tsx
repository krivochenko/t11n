...
export const Map = (props: { readonly: boolean, colorSchema: ColorSchema, flags: boolean[], countriesList: CountriesList, onChangeFlags: (flags: boolean[]) => void }) => {
  ...
  return <div>
    {!readonly && <>
        <Typography.Title level={5}>Select countries from the list...</Typography.Title>
        <Select
            mode="multiple"
            allowClear
    ...
    {!readonly ? <Typography.Title level={5}>...or tap them on the map...</Typography.Title> : null}
